...
public class SmartSimuLabelProvider extends LabelProvider {
	...
	public Image getImage(Object element) {
		if (element instanceof IProject) {
			if (((IProject) element).getName() == "Default Simulator") {
				return ImageDescriptor.createFromFile(SmartSimuLabelProvider.class, "/icons/view/simu.gif").createImage();
			}
			try {
				if (((IProject) element).hasNature(ProjectNature.SIMULATOR_PROJECT_ID)) {
					...
					return ImageDescriptor.createFromFile(SmartSimuLabelProvider.class, "/icons/view/module.gif")
							.createImage();
				} else {
					return ImageDescriptor.createFromFile(SmartSimuLabelProvider.class, "/icons/view/app.gif").createImage();
				}
